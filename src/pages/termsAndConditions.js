  ...
  <div className="page-container">
    <div className="contain-width">
      ...
      <p>
        ...
        you, whether personally or on behalf of an entity (“you”) and 1990,
        doing business as Queue ("Queue", “we”, “us”, or “our”), concerning your
        access to and use of the queuemusicapp.com website as well as any other
      ...
      <p>
        <ol>
          ...
          <li>Use the Site to advertise</li>
      ...
      <p>
        ...
        Policy: queuemusicapp.com/privacy-policy. By using the Site, you agree
      ...
      <p>
        ...
        applicable law, the arbitration will take place in United States County,
      ...
      <p>
        ...
        courts located in United States County, California, and the Parties
      ...
      <p>
        <strong>
          ...
          Phone: 8057483201
          <br />
          neilspurgeon@queuemusicapp.com
        </strong>
      </p>
    </div>
  </div>
